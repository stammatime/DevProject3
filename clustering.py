...
def main():
  ...
  plot(dat[idx==0,0],dat[idx==0,1], 'ob',
       ...
       dat[idx==3,0],dat[idx==3,1], 'oc',
       dat[idx==4,0],dat[idx==4,1], 'om',
       dat[idx==5,0],dat[idx==5,1], 'oy',
       dat[idx==6,0],dat[idx==6,1], 'ok',
       dat[idx==7,0],dat[idx==7,1], 'ob',
       dat[idx==8,0],dat[idx==8,1], 'or',
       dat[idx==9,0],dat[idx==9,1], 'og')
  ...
  # BUT IT WORKS!!!!
  sample = data_input.select(Orange.data.sample.SubsetIndices2(data_input, 10), 0)
